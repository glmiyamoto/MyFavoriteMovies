package com.glmiyamoto.carousel;
...
/**
 * This class represents the basic building block for using a 3D Carousel.
 *
 * @author Carousel view
 */
abstract class CarouselAdapter<T extends Adapter> extends ViewGroup {
     ...
     * 
     */
    static class AdapterContextMenuInfo implements ContextMenuInfo {
